...
public class StudyGroup implements Comparable<StudyGroup>, Serializable {
    ...
    public StudyGroup(int id, String name, Coordinates coordinates, long studentsCount, long expelledStudents, Integer transferredStudents, FormOfEducation formOfEducation, Person groupAdmin, String username) {
        this.id = id;
        this.name = name;
    ...
    public StudyGroup(int id, String name, Coordinates coordinates, LocalDateTime creationDate, long studentsCount, long expelledStudents, Integer transferredStudents, FormOfEducation formOfEducation, Person groupAdmin, String username) {
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
