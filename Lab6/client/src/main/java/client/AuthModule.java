...
public class AuthModule {
    ...
    public void authorize() throws IOException {
        ...
        Request request = new Request(RequestType.LOGIN, null, null, user, Locale.getDefault());
    ...
    public void register() throws IOException {
        ...
        user = new User(username, password);
        Request request = new Request(RequestType.REGISTER, null, null, user, Locale.getDefault());
        requestSender.sendRequest(connectionManager.getConnection(), request);
        try {
            Response response = reader.getResponse(connectionManager.getConnection());
            if (response.isSuccess()) {
